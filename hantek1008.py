...
try:
    ...
    # overrides.py - no-op shim for Python 3.12+ compatibility
    def overrides(func=None, **kwargs):
        if func is not None:
            return func  # handles @overrides
        return lambda f: f  # handles @overrides(check_signature=False)
except ImportError:
